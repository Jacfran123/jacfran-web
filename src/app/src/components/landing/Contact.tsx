    ...
    <>
      ...
      <section className="bg-bg-primary p-[60px] grid grid-cols-2 lg:grid-cols-1 lg:flex-col-reverse lg:flex lg:p-0">
        <div className="py-20 lg:mt-0 bg-bg-neutral px-[60px] lg:p-5 lg:pt-14 lg:pb-20">
          ...
          <div>
            <div className="flex items-center pt-5 border-b border-bg w-full mb-10 pb-3">
              <Image
            ...
            <div className="flex items-center pt-2 border-b border-bg w-full mb-10 pb-3">
              <Image
            ...
            <Button className="w-[204px] rounded-none mt-11 uppercase">
